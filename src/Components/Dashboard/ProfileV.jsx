  ...
  return (
    user && (
      <div className="container-md container-fluid sections pb-3">
        <div className="row p-3 rounded-3" style={{ height: "160px", border: "none" }}>
          <div
        ...
        <div className="row mt-2 p-1 d-flex flex-wrap gap-md-3">
          <div
            className="col-md-2 col-12 fs-5 fw-bold p-1 text-center cursor text-white bg-primary rounded-pill"
