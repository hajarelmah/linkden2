      ...
      <div className="row d-flex justify-content-center align-items-center">
        <div className="col-2 d-flex justify-content-center align-items-center mt-3">
          {user && user.pfp ? (
            ...
            <img
              src={ProfileImg} // Fallback to a default profile image
              alt="Profile"
              className="rounded-circle"
              style={{ height: "50px", width: "50px" }}
            />
        ...
        <div className="col-10 mt-3">
          <div className="input-group flex-nowrap" style={{ borderRadius: "45px" }}>
            <input
              type="text"
      ...
      <div className="row p-2 d-flex justify-content-around">
        ...
        >
          <div className="d-flex align-items-center p-1">
            <i className="fa-solid fa-photo-film fs-md-4 fs-6" style={{ color: "#378FE9" }}></i>
          </div>
          <div className="fs-md-5 fs-6 h-75 w-50 text-center" style={{ color: "#00000099" }}>
            Media
          </div>
        </div>
        ...
        >
          <div className="d-flex align-items-center p-1">
            <i className="fa-regular fa-calendar-days fs-4" style={{ color: "#C37D16" }}></i>
          </div>
          <div className="fs-md-5 fs-6 h-75 w-50 text-center" style={{ color: "#00000099" }}>
            Event
          </div>
        ...
        <div className="col-md-3 col-5 p-2 d-flex button rounded-3 justify-content-center align-items-center">
          <div className="d-flex align-items-center p-1">
            <i className="fa-solid fa-newspaper fs-4" style={{ color: "#E06847" }}></i>
          </div>
          <div className="fs-md-5 fs-6 h-75 w-75 text-center" style={{ color: "#00000099" }}>
            Write article
          </div>
        </div>
      </div>
